...
use nwc::nostr::nips::nip47::{
    ListTransactionsRequest, LookupInvoiceRequest, MakeHoldInvoiceRequest, MakeInvoiceRequest,
    Method, MultiPayInvoiceRequest, MultiPayKeysendRequest, NostrWalletConnectUri, PayInvoiceRequest,
