...
use nwc::nostr::nips::nip47::{
    ...
    MakeInvoiceRequest, Method, MultiPayInvoiceRequest, MultiPayKeysendRequest,
    NostrWalletConnectUri, PayInvoiceRequest, PayKeysendRequest, Request, Response, ResponseResult,
...
async fn test_nwc_make_hold_invoice_roundtrip() -> Result<()> {
    ...
    let request_event = Request::make_hold_invoice(params)
        .to_event(&uri)
        .expect("Failed to create NWC request event");
    nwc_client.send_event(&request_event).await?;
...
async fn test_nwc_cancel_hold_invoice_roundtrip() -> Result<()> {
    ...
    let request_event = Request::cancel_hold_invoice(params)
        .to_event(&uri)
        .expect("Failed to create NWC request event");
    nwc_client.send_event(&request_event).await?;
...
async fn test_nwc_settle_hold_invoice_roundtrip() -> Result<()> {
    ...
    let request_event = Request::settle_hold_invoice(params)
        .to_event(&uri)
        .expect("Failed to create NWC request event");
    nwc_client.send_event(&request_event).await?;
