...
// test_nwc_make_hold_invoice_roundtrip moved to tests/nwc_make_hold_invoice_roundtrip.rs

// test_nwc_cancel_hold_invoice_roundtrip moved to tests/nwc_cancel_hold_invoice_roundtrip.rs
